...
export const districtsByCity = {
  ...
  "Mardin": ["Dargeçit", "Derik", "Kızıltepe", "Mazıdağı", "Midyat", "Nusaybin", "Ömerli", "Artuklu", "Savur", "Yeşilli"],
  ...
  "Tokat": ["Almus", "Artova", "Başçiftlik", "Erbaa", "Niksar", "Ortaca", "Pazar", "Reşadiye", "Sulusaray", "Turhal", "Yeşilyurt", "Zile"],
...
export const allDistricts = Object.values(districtsByCity).flat();